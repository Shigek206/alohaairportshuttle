<html>
	<head>
		...
		<meta NAME="description" CONTENT="Airport Shuttle to and from the Honolulu Airport to Waikiki"> 
	...
	<section class="masthead-sub-cnt waikiki"></section>

	<?php include 'includes/waikiki-shuttle-info.php';?>
